...
class SassScriptFunctions {
	...
	/*
	 * Crops hash from hex colour, eg #ffcc00 -> ffcc00
 	 * Created 08.04.2011 by DS @ Chrometoaster
	 * Inspiration: https://github.com/nex3/haml/issues/368
	 */

	public static function url_safe_color($color) {
		return new SassString( str_replace('#', '', $color) );
	}	
	
	/*
	 * Crops unit from value, eg 3px -> 3
 	 * Created 14.07.2011 by DS @ Chrometoaster
	 */

	public static function nounit($str) {
		$str2 = $str;
		$str2 = str_replace('em', '', $str2);
		$str2 = str_replace('px', '', $str2);
		$str2 = str_replace('pt', '', $str2);		
		$str2 = str_replace('"', '', $str2);										
		
		return new SassString( $str2 );
	}		
